<?php
/**
 * Миграция m131029_065937_news_table
 *
 * @property string $prefix
 */
 
class m131029_065937_news_table extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{news_table}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{news_table}}', array(
            'id' => 'pk', // auto increment

			'title' => "string NOT NULL COMMENT 'Заголовок'",
            'dt_date' => "date COMMENT 'Дата'",
            'wswg_news_body' => "text COMMENT 'Контент'",
            'news_type' => 'tinyint COMMENT "Тип материала"',
