<?php
/**
 * Миграция m131028_064920_page_table
 *
 * @property string $prefix
 */
 
class m131028_064920_page_table extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{page_table}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{page_table}}', array(
            'id' => 'pk', // auto increment
            'title' => "string COMMENT 'Заголовок'",
            'alias' => "string COMMENT 'Url'",
