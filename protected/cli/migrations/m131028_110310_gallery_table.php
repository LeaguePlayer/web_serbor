<?php
/**
 * Миграция m131028_110310_gallery_table
 *
 * @property string $prefix
 */
 
class m131028_110310_gallery_table extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{gallery_table}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{gallery_table}}', array(
